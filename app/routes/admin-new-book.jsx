...
export default function AdminNewBook() {
  ...
  return (
    <div className="container-fluid">
      <div className="row">
        {/* Sidebar Corregido */}
        <div className="col-md-3 col-lg-2 bg-light border-end vh-100 position-fixed">
          <div className="p-3">
            <h4 className="text-center mb-4 text-primary">BooketList Admin</h4>
            <nav className="nav flex-column">
              <Link to="/admin" className="nav-link text-dark mb-2">
                <i className="fas fa-tachometer-alt me-2"></i>Dashboard
              </Link>
              <Link to="/admin/users" className="nav-link text-dark mb-2">
                <i className="fas fa-users me-2"></i>Gestión de Usuarios
              </Link>
              <Link to="/admin/books" className="nav-link text-dark mb-2 active">
